...
- **20 ก.ค. 2026** — กลับมาทดลองสูตรเทรดต่อ หลัง "เล่นรายตัวแพ้ RMF ทุกทาง" ที่เจอก่อนหน้านี้: ลอง
  ...
  🆕🆕🆕🆕🆕🆕 ด้านล่าง)
- **20 ก.ค. 2026** — เปลี่ยนโจทย์จากกลยุทธ์เทรดมาเป็น RMF กสิกร: เทียบ RMF S&P500 (มีคืนภาษี 25%) vs
...
### 🆕🆕🆕🆕 RMF กสิกร vs กลยุทธ์เทรดของเราเอง + กระจายพอร์ต (20 ก.ค. 2026)
...
### 🆕🆕🆕🆕🆕 ผลตอบแทน "หลังภาษีจริง" + Tracking Error ของ DR จริง (20 ก.ค. 2026 ต่อ)
