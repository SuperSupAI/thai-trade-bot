...
† ยังไม่ได้ยืนยันว่า DR ที่อ้างอิงหุ้นนอกสหรัฐฯ (ญี่ปุ่น/ฮ่องกง/สิงคโปร์) ได้รับยกเว้นภาษีเหมือน DR สหรัฐฯ
แน่ชัด 100% — เป็นสมมติฐานที่ยังไม่เช็คลึก (ดู "ทำอะไรต่อดี" ที่เคยเสนอไว้)
‡ ตัวเลข RMF เป็นผลตอบแทนหลังภาษีของทุนก้อนเดียว ไม่ใช่สูตร momentum — เป็นค่าเปรียบเทียบ ไม่ใช่สิ่งที่
ต้อง optimize เพิ่ม (กองทุนสำเร็จรูปเลือกได้แค่ว่าจะซื้อกองไหน)
