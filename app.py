...
ทุน 10,000 บาท ÷ top_n=3-5 → งบต่อไม้เหลือแค่ ~$56-94 **ซื้อหุ้น mega-cap ที่มี DR ไม่ได้เลยแม้แต่ตัวเดียว**
(META/COST/GOOGL ราคาแพงกว่างบต่อไม้) ผลคือ **0 ไม้ 0% ตลอดเดือน ไม่ใช่ขาดทุน แค่ "ทำไม่ได้" ไปเลย** —
ทุน 100,000 บาทขึ้นไปเริ่มซื้อได้จริง สอดคล้องกับ capital sensitivity ที่เจอตั้งแต่รอบแรกของโปรเจกต์
(ทุนต่ำกว่า ~50,000 บาทมีปัญหาซื้อหุ้นแพงไม่ได้เสมอ)
